...
#define MOTOR_CONTROL_THREAD_TMR_DRV                       1
#define MOTOR_CONTROL_THREAD_TMR_DRV_IS_PERIODIC           true
#define MOTOR_CONTROL_THREAD_TMR_DRV_PERIOD                0x3d09

/*** Application Instance 2 Configuration ***/
#define COMMUNICATION_THREAD_TMR_DRV                       0
#define COMMUNICATION_THREAD_TMR_DRV_IS_PERIODIC           true
#define COMMUNICATION_THREAD_TMR_DRV_PERIOD                0x3d09
